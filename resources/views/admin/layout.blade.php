...
<head>
    ...
    <title>@yield('title') | Mirage Park Resort Hotel Admin Paneli</title>
    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="{{ route('admin.') }}" class="nav-link"> Mirage Park Resort Hotel </a>
            </li>
        </ul>
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="submenu2" data-parent="#accordionExample">
                        <li>
                            <a href="{{ route('admin.component-parents.index') }}"> Component Grupları </a>
                        </li>
                        <li>
                            ...
                            <ul class="collapse list-unstyled sub-submenu" id="sm2" data-parent="#submenu2">
                                ...
                                <li>
                                    <a href="javascript:void(0);"> Componentleri Listele </a>
                                </li>
                            </ul>
                        </li>
                    </ul>
